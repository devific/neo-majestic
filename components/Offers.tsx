...
const offers = [
  ...
  {
    title: "Get Cozy",
    image: "https://images.unsplash.com/photo-1501117716987-c8e1ecb210ff?q=80&w=1000",
  ...
  return (
    <Section background="bg-sand" id="rooms">
      <div className="text-center mb-16">
        <h2 className="font-serif text-4xl md:text-5xl text-navy font-bold mb-4">Awesome Offers</h2>
        <p className="text-navy-deep/60 max-w-2xl mx-auto">
          For anything that brings people together to celebrate an occasion, we create truly memorable experiences.
        </p>
      </div>
        ...
        {offers.map((offer, index) => (
          ...
          >
            ...
            <div className="p-8 flex-1 flex flex-col">
              <h3 className="font-serif text-2xl text-navy font-bold mb-4">{offer.title}</h3>
              <p className="text-navy-deep/70 text-sm leading-relaxed mb-6 flex-1">
                {offer.desc}
              </p>
              
              <div className="mt-auto pt-6 border-t border-gray-100 flex items-center justify-between">
                <a href="#" className="flex items-center text-sm font-bold text-gold hover:text-navy transition-colors">
