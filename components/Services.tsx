      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl text-navy font-bold leading-tight">
            Our Services & <br />Facilities
          </h2>
          <p className="text-navy-deep/70 text-lg leading-relaxed max-w-lg">
            Neo Majestic is a 5 Star, business hotel in Goa. It's a part of the Majestic Pride Group. 
            There are 94 luxurious rooms with king-size beds and state-of-the-art facilities along with 
            a host of leisure activities to offer you a relaxed and entertaining experience, while you are on business in Goa.
          </p>
          <a href="#" className="inline-flex items-center text-gold font-semibold tracking-wide hover:text-gold-dark transition-colors group">
            READ MORE 
        ...
        <div className="grid grid-cols-2 gap-6 md:gap-8">
          ...
          >
            <div className="relative rounded-2xl overflow-hidden shadow-2xl group aspect-[3/4]">
              <img 
                src="https://images.unsplash.com/photo-1549880181-56a44cf4a9a9?q=80&w=1000&auto=format&fit=crop" 
                alt="Golden Buddha"
